...
@single_experiment
def experiment(env: str = 'wall_hitting_drone_gym',
               group_name: str = "test_single",
               n_envs: int = 1,
               alg: str = "bsmp_eppo_wall_hitting_drone",
    ...
    name = (f"ePPO_drone_tdiv1qdiv50_150_"
            f"gamma099_hor150_"
    ...
    # wandb_run = wandb.init(project="corl24_experiments_wall_hitting_drone", config=config, dir=results_dir, name=name, entity="kicai",
